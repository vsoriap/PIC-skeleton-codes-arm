...
/* align memory for SSE */
   ...
   fallocate(&cue,ndim*nxe*nye,&irc);
   fallocate(&fxyze,ndim*nxe*nye,&irc);
   fallocate(&bxyze,ndim*nxe*nye,&irc);
   callocate(&exyz,ndim*nxeh*nye,&irc);
   callocate(&bxyz,ndim*nxeh*nye,&irc);
   callocate(&ffc,nxh*nyh,&irc);
   iallocate(&npicy,ny1,&irc);
   if (irc != 0) {
